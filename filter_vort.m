% [zetaf,uf,vf] = filter_vort(domain,zetai,ui,vi,sigma)
% Explicit filter for removing surface gravity waves
%
% Input:
...
function [zetaf,uf,vf] = filter_vort(domain,zetai,ui,vi)
...
[zetaf,res] = diffequation_vort(domain,q,bc,zeta_bc);
